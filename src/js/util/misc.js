...
export const KeyCode = {
	...
	BACKTICK: 192, TILDE: 192, MINUS: 189, UNDERSCORE: 189,
	EQUALS: 187, PLUS: 187, L_BRACKET: 219, L_CURLY: 219,
...
export function setTooltip(element, message, immediate = false) {
	...
	if (immediate) {
		...
		if (
			window.clientX < rect.left ||
			window.clientX > rect.right ||
			window.clientY < rect.top ||
			window.clientY > rect.bottom
		) return;
